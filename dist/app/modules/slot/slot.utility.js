...
const createSlots = (startTime, endTime, date, service) => {
    const serviceDuration = 60;
    // convert to minutes -> ["9", "30"][0,1]*60
    const startMinutes = parseInt(startTime.split(':')[0]) * serviceDuration +
        parseInt(startTime.split(':')[1]);
    const endMinutes = parseInt(endTime.split(':')[0]) * serviceDuration +
